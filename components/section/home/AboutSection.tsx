    ...
    <div
      ...
      <div className="container mx-auto md:flex md:justify-around mb-18">
        <div className="space-y-2 mb-10 md:mb-0 md:w-1/3">
          <h3 className="text-3xl md:text-6xl font-semibold mb-5">
            <TextReveal as="span" className="block leading-tight" text="夢を夢で" startDelay={0.2} />
            <TextReveal as="span" className="block leading-tight" text="終わらせない" startDelay={0.5} />
          </h3>
          <p className="text-sm md:text-lg text-muted-foreground">
            <TextReveal as="span" text="AIの力で、すべての学生が自分の可能性を信じ、それを実現するための手段を得られる社会へ" startDelay={0.7} />
          </p>
        </div>
      ...
      <div>
        <dl className="flex flex-col md:flex-row md:items-center md:justify-around">
          ...
          <div className="text-center font-bold">
            <dt className="text-lg text-muted-foreground mb-1">
              <TextReveal as="span" text="設立年月" startDelay={0.2} />
            </dt>
            <dd className="text-3xl mb-6 md:mb-0">
              <TextReveal as="span" text="2024年11月" startDelay={0.5} />
            </dd>
          </div>
          <div className="text-center font-bold">
            <dt className="text-lg text-muted-foreground mb-1">
              <TextReveal as="span" text="事業内容" startDelay={0.2} />
            </dt>
            <dd className="text-3xl mb-6 md:mb-0">
              <TextReveal as="span" text="EdTech事業" startDelay={0.5} />
            </dd>
          </div>
        </dl>
      </div>
